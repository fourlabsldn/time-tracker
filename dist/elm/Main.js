...
var _fourlabsldn$time_tracker$Main_Types$Project = F4(
	function (a, b, c, d) {
		return {name: a, url: b, selectedDeliverable: c, unselectedDeliverables: d};
	});
var _fourlabsldn$time_tracker$Main_Types$Deliverable = F3(
	function (a, b, c) {
		return {name: a, url: b, recording: c};
	});
var _fourlabsldn$time_tracker$Main_Types$Recording = F2(
	function (a, b) {
		return {startTime: a, intervals: b};
	});
var _fourlabsldn$time_tracker$Main_Types$TimeInterval = F2(
	function (a, b) {
...
var _fourlabsldn$time_tracker$Main_Types$SetProjects = function (a) {
	return {ctor: 'SetProjects', _0: a};
};
var _fourlabsldn$time_tracker$Main_Types$SelectProject = function (a) {
	return {ctor: 'SelectProject', _0: a};
};
var _fourlabsldn$time_tracker$Main_Types$SelectDeliverable = F2(
	function (a, b) {
...
var _fourlabsldn$time_tracker$Main_Utils$allDeliverables = function (project) {
	...
	if (_p0.ctor === 'Nothing') {
		return project.unselectedDeliverables;
	} else {
		return {ctor: '::', _0: _p0._0, _1: project.unselectedDeliverables};
	}
};
var _fourlabsldn$time_tracker$Main_Utils$allProjects = function (model) {
	var _p1 = model.selectedProject;
	if (_p1.ctor === 'Nothing') {
		return model.unselectedProjects;
	} else {
		return {ctor: '::', _0: _p1._0, _1: model.unselectedProjects};
	}
};

var _fourlabsldn$time_tracker$Main_State$updateProject = F2(
	function (model, newProject) {
		var newProjectIsSelected = A2(
			_elm_lang$core$Maybe$withDefault,
			false,
			A2(
		...
		return newProjectIsSelected ? _elm_lang$core$Native_Utils.update(
			model,
			{
				selectedProject: _elm_lang$core$Maybe$Just(newProject)
			...
			model,
			{
				unselectedProjects: A2(
					_elm_lang$core$List$map,
					function (p) {
						return _elm_lang$core$Native_Utils.eq(p.name, newProject.name) ? newProject : p;
					},
...
var _fourlabsldn$time_tracker$Main_State$update = F2(
	function (msg, model) {
		...
		switch (_p1.ctor) {
			...
			case 'SelectDeliverable':
				...
				var isProjectSelected = function () {
					...
					if (_p2.ctor === 'Nothing') {
						...
						return _elm_lang$core$Native_Utils.eq(_p2._0, _p5);
					}
				}();
				if (!isProjectSelected) {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				} else {
					var newSelectedProject = function () {
						var _p3 = _p1._1;
						if (_p3.ctor === 'Nothing') {
							return _elm_lang$core$Native_Utils.update(
								_p5,
								{
									selectedDeliverable: _elm_lang$core$Maybe$Nothing,
									unselectedDeliverables: _fourlabsldn$time_tracker$Main_Utils$allDeliverables(_p5)
								});
						} else {
							var _p4 = _p3._0;
							return _elm_lang$core$Native_Utils.update(
								_p5,
								{
									selectedDeliverable: _elm_lang$core$Maybe$Just(_p4),
									unselectedDeliverables: A2(
										_elm_lang$core$List$filter,
										F2(
											function (x, y) {
												return !_elm_lang$core$Native_Utils.eq(x, y);
											})(_p4),
										_fourlabsldn$time_tracker$Main_Utils$allDeliverables(_p5))
								});
						}
					}();
					return {
			...
			case 'SelectProject':
				var _p8 = _p1._0;
				var newUnselectedProjects = function () {
					var _p6 = _p8;
					if (_p6.ctor === 'Nothing') {
						return _fourlabsldn$time_tracker$Main_Utils$allProjects(model);
					} else {
						return A2(
							_elm_lang$core$List$filter,
							function (_p7) {
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{selectedProject: _p8, unselectedProjects: newUnselectedProjects}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'SetProjects':
				return {
			...
			case 'ToggleRecording':
				...
				var newProject = _elm_lang$core$Native_Utils.update(
					_p1._0,
					{
						selectedDeliverable: _elm_lang$core$Maybe$Just(newDeliverable)
					});
				return {
					ctor: '_Tuple2',
...
var _fourlabsldn$time_tracker$Main_View$isRecording = function (recording) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		false,
		A2(
...
var _fourlabsldn$time_tracker$Main_View$toTwoDigits = function (_p1) {
	return A2(
...
var _fourlabsldn$time_tracker$Main_View$timeTracker = F2(
	function (clock, recording) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('TimeTracker-timer-time'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text(
					_fourlabsldn$time_tracker$Main_View$prettyTime(
						A2(_fourlabsldn$time_tracker$Main_View$totalDuration, clock, recording))),
				_1: {ctor: '[]'}
			});
	});
var _fourlabsldn$time_tracker$Main_View$recordingInfoView = F2(
	function (clock, info) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('TimeTracker-RecordingRow'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('TimeTracker-RecordingRow-names'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('TimeTracker-RecordingRow-deliverableName'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(info.deliverable.name),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('TimeTracker-RecordingRow-projectName'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text(info.project.name),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: A2(_fourlabsldn$time_tracker$Main_View$timeTracker, clock, info.recording),
						_1: {ctor: '[]'}
					}
				}
			});
...
var _fourlabsldn$time_tracker$Main_View$RecordingInfo = F3(
	function (a, b, c) {
		return {project: a, deliverable: b, recording: c};
	});
var _fourlabsldn$time_tracker$Main_View$projectRecordingInfos = function (project) {
	return A2(
		_elm_lang$core$List$map,
		function (d) {
			return A3(_fourlabsldn$time_tracker$Main_View$RecordingInfo, project, d, d.recording);
		},
		_fourlabsldn$time_tracker$Main_Utils$allDeliverables(project));
};
var _fourlabsldn$time_tracker$Main_View$allRecordingInfos = function (model) {
	return _elm_lang$core$List$concat(
		A2(
			_elm_lang$core$List$map,
			_fourlabsldn$time_tracker$Main_View$projectRecordingInfos,
			_fourlabsldn$time_tracker$Main_Utils$allProjects(model)));
};
var _fourlabsldn$time_tracker$Main_View$allStartedTimers = function (model) {
	return A2(
		_elm_lang$core$List$filter,
		function (info) {
			return A2(
				...
				0,
				A2(_fourlabsldn$time_tracker$Main_View$totalDuration, model.clock, info.recording));
		},
		_fourlabsldn$time_tracker$Main_View$allRecordingInfos(model));
};
var _fourlabsldn$time_tracker$Main_View$view = function (model) {
	var isRecordingOn = A2(
		_elm_lang$core$Maybe$withDefault,
		false,
		A2(
			_elm_lang$core$Maybe$map,
			_fourlabsldn$time_tracker$Main_View$isRecording,
			A2(
				_elm_lang$core$Maybe$map,
				function (_) {
					return _.recording;
		...
		},
		{
			...
			_0: A2(
				_elm_lang$html$Html$div,
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class(
						isRecordingOn ? 'TimeTracker-timer TimeTracker-timer--recording' : 'TimeTracker-timer'),
					_1: {
						ctor: '::',
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('TimeTracker-fields'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('TimeTracker-projects'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
									...
									_elm_lang$html$Html$select,
									{
										...
										_1: {
											...
											_0: _fourlabsldn$time_tracker$Main_View$onChange(
												function (n) {
													return _fourlabsldn$time_tracker$Main_Types$SelectProject(
														A2(
															_elm_community$list_extra$List_Extra$find,
															function (p) {
																return _elm_lang$core$Native_Utils.eq(p.name, n);
															},
															availableProjects));
												}),
											_1: {ctor: '[]'}
							...
							_1: {
								...
								_0: A2(
									_elm_lang$html$Html$button,
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class(
											isRecordingOn ? 'TimeTracker-start-stop btn btn-danger' : 'TimeTracker-start-stop btn btn-default'),
										_1: {
											ctor: '::',
								...
								_1: {
									...
									_0: A2(
										...
										A2(
											_elm_lang$core$List$map,
											_fourlabsldn$time_tracker$Main_View$recordingInfoView(model.clock),
											_fourlabsldn$time_tracker$Main_View$allStartedTimers(model))),
									_1: {ctor: '[]'}
								}
							}
						}
...
var _fourlabsldn$time_tracker$Main$placeholderProjects = {
	ctor: '::',
	_0: {
...
var _fourlabsldn$time_tracker$Main$main = _elm_lang$html$Html$program(
	{
		init: {
			ctor: '_Tuple2',
			_0: _fourlabsldn$time_tracker$Main_State$init(_fourlabsldn$time_tracker$Main$placeholderProjects),
			_1: _elm_lang$core$Platform_Cmd$none
		},
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _fourlabsldn$time_tracker$Main$main !== 'undefined') {
    _fourlabsldn$time_tracker$Main$main(Elm['Main'], 'Main', undefined);
}
